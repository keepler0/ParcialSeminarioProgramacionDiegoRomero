...
namespace Bombones.IoC
{
    public static class DI
    {
        public static IServiceProvider ConfigurarServicios()
        {
            ...
            service.AddScoped<IRepositorioFormasDeVentas, RepositorioFormasDeVentas>();
            ...
            service.AddScoped<IServiciosFormasDeVentas>(sp => {
                var repositorio = new RepositorioFormasDeVentas();
                return new ServiciosFormasDeVentas(repositorio, cadena);
            });
